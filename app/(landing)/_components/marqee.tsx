      ...
      <div className='mt-32 flex flex-col gap-4 md:mt-12 md:flex-row items-center justify-between w-full px-4 lg:px-12'>
        <div className='bg-[#D9D9D933] flex flex-col items-center justify-center p-2 rounded-3xl w-full md:w-[400px]'>
          ...
          <button
            ...
            className='flex hover:cursor-pointer items-center justify-center rounded-xl py-3 w-full text-white bg-[#5CAF69]'>Invest Now</button>
        </div>
        <div className='bg-[#D9D9D933] bg-opacity-50 flex flex-col items-center justify-center p-2 rounded-3xl w-full md:w-[400px]'>
          ...
          <button 
            onClick={() =>
              openModal(
                <iframe src="https://docs.google.com/forms/d/e/1FAIpQLSdycDBUjIDj1vi6tper18Wi2z3UPOHtUrFwtRLqS7ksS7cB6w/viewform?embedded=true" width="640" height="1270" frameBorder="0" marginHeight={0} marginWidth={0}>Loading…</iframe>
              )
            }
            className='flex hover:cursor-pointer items-center justify-center rounded-xl py-3 w-full text-white bg-[#217E7E]'>I want a meeting</button>
        </div>
        <div className='bg-[#D9D9D933] flex flex-col items-center justify-center p-2 rounded-3xl w-full md:w-[400px]'>
          ...
          <button 
            ...
            className='flex hover:cursor-pointer items-center justify-center rounded-xl py-3 w-full text-white bg-[#3770AD]'>Join Next Public Pitch</button>
        </div>
      </div>
      <Modal />
    </motion.div>
