...
export const TeamComponent = () => {
  return (
    <div className="py-16 w-full text-white h-fit relative">
      ...
      {/*small screen text*/}
      <Image alt='' src='https://res.cloudinary.com/drykej1am/image/upload/v1741783872/weeshr-funding/WEESHR_CORE_1_waoxvg.png' width={300} height={300} className="w-60 h-60 absolute bottom-0 left-0 lg:hidden -z-0" />
