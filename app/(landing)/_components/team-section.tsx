...
export const TeamComponent = () => {
  return (
    <div className="py-16 w-full text-white h-fit relative">
      {/*lg screen text*/}
      <Image alt='' src='https://res.cloudinary.com/drykej1am/image/upload/v1741783884/weeshr-funding/WEESHR_CORE_fmuimv.png' width={300} height={300} className="w-60 h-full py-[20%] absolute top-0 left-[20%] hidden lg:block -z-10" />
      {/*small screen text*/}
      <Image alt='' src='https://res.cloudinary.com/drykej1am/image/upload/v1741783872/weeshr-funding/WEESHR_CORE_1_waoxvg.png' width={300} height={300} className="w-60 h-full absolute bottom-0 left-52 hidden lg:block -z-0" />
