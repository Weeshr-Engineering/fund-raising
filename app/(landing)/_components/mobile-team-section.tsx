...
const teamData = [
  ...
  },
  {
    ...
    title: "Co-founder/CEO",
    content:
      "Innovative Full-tack Software Engineer with 5+ years of experience in front-ed & back-end development. Worked on Web3 projects like Birble Al and Tradenly.pro and Web2 projects Wealth.ng, Sankore, Kada, Weeshr & more. OCA, OCP certified, skilled in React, Node, Vue & Tailwind CSS.",
    image:
    ...
    <div className="relative w-full overflow-hidden">
      <Marquee pauseOnHover speed={50} gradient={false} className="w-full">
        {teamData.map((el, idx) => (
          <div
            key={idx}
            className="flex flex-col w-[244px] h-[520px] rounded-4xl bg-[#E7E9F2] text-black mx-4 transition-all duration-500 ease-in-out hover:bg-[#d1d5db] group cursor-pointer"
          >
