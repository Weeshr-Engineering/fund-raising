...
const PhoneUI = () => {
  // const data
  return (
    <div className='w-full mt-12 lg:mt-36 h-[70dvh] flex flex-col items-center justify-center rounded-3xl lg:rounded-[70px] relative'>
      <Image className='absolute top-0 left-0 -z-10 w-full h-full rounded-3xl lg:rounded-[70px] overflow-hidden' src='https://res.cloudinary.com/drykej1am/image/upload/v1741757808/weeshr-funding/Rectangle_3847_1_gozlia.png' alt='' width={500} height={500} />
      {/*weeshr text*/}
      ...
      {/*phone image*/}
      <Image className='absolute place-self-center bottom-0 right-0 w-[140%] lg:w-[50%] h-[80%] lg:h-[950px]' src='https://res.cloudinary.com/drykej1am/image/upload/v1741769959/weeshr-funding/iPhones_rerbdo.png' alt='' width={500} height={700} />

      {/*<Image className='absolute place-self-center bottom-0 right-0 w-full h-[70%]' src='https://res.cloudinary.com/drykej1am/image/upload/v1741769959/weeshr-funding/iPhones_rerbdo.png' alt='iphone' width={500} height={900} />*/}

      {/*rock base*/}
      <Image className='absolute place-self-center bottom-0 right-0 w-full lg:w-[55%] lg:place-self-start lg:right-0 h-36' src='https://res.cloudinary.com/drykej1am/image/upload/v1741757808/weeshr-funding/mockup_9_Background_Removed_1_chlizf.png' alt='' width={600} height={600} />
      <div className='absolute top-0 left-0 w-full h-full z-50 hidden lg:block'>
        <div className='w-full h-full relative'>
          <div className='absolute hover:p-4 bottom-[397px] left-[64px] flex items-center justify-center gap-4 p-3 rounded-full bg-white shadow-md'>
          ...
          <div className='absolute hover:p-4 bottom-[147px] left-[179px] flex items-center justify-center gap-4 p-3 rounded-full bg-white shadow-md'>
          ...
          <div className='absolute hover:p-4 top-[127px] right-[54px] z-50 flex items-center justify-center gap-4 p-3 rounded-full bg-white shadow-md'>
          ...
          <div className='absolute hover:p-4 left-[597px] bottom-[123px] flex items-center justify-center gap-4 p-3 rounded-full bg-white shadow-md'>
          ...
          <div className='absolute hover:p-4 bottom-[282px] left-[432px] flex items-center justify-center gap-4 p-3 rounded-full bg-white shadow-md'>
          ...
          <div className='absolute hover:p-4 top-[265px] right-[533px] flex items-center justify-center gap-4 p-3 rounded-full bg-white shadow-md'>
          ...
          <div className='absolute hover:p-4 bottom-[202px] right-[48px] flex items-center justify-center gap-4 p-3 rounded-full bg-white shadow-md'>
