    ...
    <AnimatePresence mode="wait">
      <div className="justify-around hidden sm:flex">
        <motion.div
          ...
          className={cn(
            "flex md:w-[40%] max-w-md  fixed top-10 inset-x-0 mx-auto border border-transparent dark:border-white/[0.2] rounded-full  bg-foreground shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)] z-[5000] pr-2 pl-6 py-2 items-center justify-between space-x-4",
            className
          )}
        >
